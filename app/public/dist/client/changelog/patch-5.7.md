...
- Monter changes:
    - (2) Pursuit: When KOing its target, gain 3 Attack , 10% Ability Power and ~~30 max HP~~ **20% of its max HP**
    - (4) Brutal Swing: When KOing its target, gain 6 Attack , 20% Ability Power and ~~60 max HP~~ **40% of its max HP**
    - (6) Power Trip:  When KOing its target, gain 10 Attack , 30% Ability Power and ~~100 max HP~~ **60% of its max HP**
