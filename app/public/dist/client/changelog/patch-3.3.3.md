...
- Max Revive now gives Resurrection status, and so can no longer be stacked with another Resurrection from an ability
...
- On-KO effects are now triggered even when target has Resurrection, Fossil revive or Max revive
