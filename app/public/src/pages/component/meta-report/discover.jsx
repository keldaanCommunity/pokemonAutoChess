            ...
            tooltip:{
                custom: function({series, seriesIndex, dataPointIndex, w}) {
                    return (`<div class='nes-container'
                        ...
                        ${Object.keys(self.props.meta[seriesIndex].teams[dataPointIndex].pokemons).reduce((prev, curr)=>{return prev + '<img src=' + `"${CDN_PORTRAIT_URL}${PokemonFactory.createPokemonFromName(curr).index.replace('-','/')}/${Emotion.NORMAL}.png"` + '/>'},'')}
                        </div>
                    </div>`)
                }
            }
