...
class WikiFaq extends Component{
    ...
    render(){
        return <div style={{overflowY: 'scroll', height: '80vh'}}>
            <h5 className="nes-text is-primary">Is this an official game ?</h5>
            <p>No, this is a fan game; made by fans, for fans. All rights/credits to Pokemon Company.</p>
            <h5 className="nes-text is-primary">How do pokemon evolves ?</h5>
            <p>You need 3 copies of the same pokemon to get the evolution. The 3 pokemons will merge to give the evolved pokemon.</p>
            <h5 className="nes-text is-primary">Why is there field/flora/human/aquatic synergies ? They don't match any of pokemon types</h5>
            ...
            <h5 className="nes-text is-primary">How does Ditto work ?</h5>
            ...
            <h5 className="nes-text is-primary">How do the items works ?</h5>
            ...
            <h5 className="nes-text is-primary">How do the fossils works ?</h5>
            ...
            <h5 className="nes-text is-primary">How do bots works ?</h5>
            ...
            <h5 className="nes-text is-primary">Can i create my own bot ?</h5>
            ...
            <h5 className="nes-text is-primary">How does the elo system work ?</h5>
            ...
            <h5 className="nes-text is-primary">I didn't get elo points in my last game, why ?</h5>
            ...
            <h5 className="nes-text is-primary">What are the special damages and physical damages ?</h5>
            ...
            <h5 className="nes-text is-primary">Where do primal groudon and primal kyogre come in are they something you can get or are they just pve ?</h5>
