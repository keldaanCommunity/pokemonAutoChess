...
export default function PokemonEmotion(props:{index: string, shiny: boolean, unlocked: boolean | undefined, path: string, emotion:Emotion}){
    ...
    return <div className='nes-container' style={cursorStyle} data-tip data-for={`${props.path}-${props.emotion}`} onClick={()=>{
        ...
        <ReactTooltip id={`${props.path}-${props.emotion}`}
            ...
            <div style={{display:'flex', alignItems: 'center'}}>
                <img style={{width:'80px', height:'80px', imageRendering:'pixelated'}} src={getPortraitSrc(props.index, props.shiny, props.emotion)}></img>
