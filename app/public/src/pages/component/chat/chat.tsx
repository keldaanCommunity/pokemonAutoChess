    ...
    flexBasis: '30%'
      ...
      <form onSubmit={(e)=>{
        ...
        <div className="nes-field" style={{width: '80%'}}>
          <input placeholder='Type here ...' id="name_field" type="text" onChange={(e)=>{setCurrentText(e.target.value)}} value={currentText} className='my-input'/>
        </div>
        <button style={{height:'7vh'}} className="bubbly-primary">Send</button>
      </form>
    </div>
}