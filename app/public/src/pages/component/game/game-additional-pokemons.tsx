    ...
    return <>
      ...
      <div className="nes-container game-additional-pokemons" data-tip data-for="detail-additional-pokemons">
        {additionalPokemons.map((p, index) => {
          ...
          return (<React.Fragment key={"additional-pokemon-tooltip-"+index}>
            <ReactTooltip
            ...
            >
              <GamePokemonDetail pokemon={pokemon} pokemonConfig={pokemonCollection.get(pokemon.index)} />
            </ReactTooltip>
            <img src={getPortraitSrc(PkmIndex[p])} data-tip data-for={"additional-pokemon-" + p} />
          </React.Fragment>)
        })}
      </div>
    </>
