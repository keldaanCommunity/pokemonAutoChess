...
export default function GameModal(props:{modalInfo: string, modalTitle: string, modalBoolean: boolean, hideModal: Dispatch<SetStateAction<boolean>>, leave: ()=>void}) {
    return <Modal show={props.modalBoolean} onHide={()=>{props.hideModal}}>
    <Modal.Header>
    ...
    <Modal.Footer>
      <button style={buttonStyle} className='nes-btn is-primary' onClick={()=>{props.hideModal}}>Cancel</button>
