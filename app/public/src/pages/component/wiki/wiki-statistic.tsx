    ...
    <ul className="wiki-stat">
      <li className="my-box">
        ...
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.HP"))}
        </p>
      </li>
      <li className="my-box">
      ...
      <li className="my-box">
        ...
        <h2>{t("stat.DEF")}</h2>
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.DEF"))}
        </p>
      </li>
      <li className="my-box">
        ...
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.SPE_DEF"))}
        </p>
      </li>
      <li className="my-box">
        ...
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.MAX_PP"))}
        </p>
      </li>
      <li className="my-box">
        ...
        <h2>{t("stat.AP")}</h2>
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.AP"))}
        </p>
      </li>
      <li className="my-box">
        ...
        <h2>{t("stat.ATK")}</h2>
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.ATK"))}
        </p>
      </li>
      <li className="my-box">
        ...
        <h2>{t("stat.RANGE")}</h2>
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.RANGE"))}
        </p>
      </li>
      <li className="my-box">
      ...
      <li className="my-box">
        ...
        <h2>{t("stat.LUCK")}</h2>
        <p className="description">
          {addIconsToDescription(t("wiki.statistics.stat_description.LUCK"))}
        </p>
      </li>
    </ul>
  )
