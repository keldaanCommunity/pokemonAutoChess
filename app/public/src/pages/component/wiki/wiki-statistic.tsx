  ...
  return (
    <ul className="wiki-stat">
      ...
      <li className="nes-container">
        ...
        <p>Defense points</p>
        <p className="description">{addIconsToDescription(`Reduces PHYSICAL received`)}</p>
      </li>
      <li className="nes-container">
        <img style={imgStyle} src="assets/icons/speDef.png"></img>
        <p>Special Defense points</p>
        <p className="description">{addIconsToDescription(`Reduces SPECIAL received`)}</p>
      </li>
      <li className="nes-container">
      ...
      <li className="nes-container">
        ...
        <p>Ability Power (%)</p>
        <p className="description">{addIconsToDescription(`Increase SPECIAL and ability effects in various ways.`)}</p>
      </li>
      <li className="nes-container">
        <img style={imgStyle} src="assets/icons/atk.png"></img>
        <p>Attack Damage</p>
        <p className="description">{addIconsToDescription(`Damage inflicted on each basic attack`)}</p>
      </li>
      <li className="nes-container">
        <img style={imgStyle} src="assets/icons/range.png"></img>
        <p>Attack Range</p>
        <p className="description">{addIconsToDescription(`1-range pokemon are melee`)}</p>
      </li>
      <li className="nes-container">
      ...
      <li className="nes-container">
        ...
        <p className="description">{addIconsToDescription(`Critical hits deal 2x more damage. Abilities cannot crit by default.`)}</p>
      </li>
      <li className="nes-container">
        <img style={imgStyle} src="assets/icons/critDamage.png"></img>
        <p>Critical hit damage</p>
        <p className="description">{addIconsToDescription(`Multiplier for critical hits additional damage`)}</p>
      </li>
    </ul>
  )
}
