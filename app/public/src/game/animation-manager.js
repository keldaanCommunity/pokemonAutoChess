export default class AnimationManager {
  constructor(game) {
    ...
    [10, 11, 12, 13, 14, 15, 16, 17, 18, 74, 75, 76, 298, 183, 184, 41 ,42, 169, 179, 180, 181, 173, 35, 36, 174, 39, 40, 187, 188, 189, 273, 274, 275, 396, 397
    , 398].forEach(num => {
      this.createAnimations(num,"COMMON");
    });

    [1,2,3,4,5,6,7,8,9,32,33,34,152,153,154,155,156,157,158,159,160,252,253,254,255,256,257,258,259,260,387,388,389,390,391,392,393,394,395].forEach(num => {
