...
import {SPECIAL_SKILL, PKM_ORIENTATION, PKM_ACTION} from '../../../models/enum';
...
export default class AnimationManager {
  ...
  animatePokemon(entity: Pokemon, action: PKM_ACTION) {
    const key = `${entity.padIndex}/Normal/${action}/Anim/${PKM_ORIENTATION[entity.orientation]}`;
    entity.sprite.anims.play(key);
  }
