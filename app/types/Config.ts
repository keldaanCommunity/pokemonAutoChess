...
export const MaskCoordinate: {[key in Mask]: {x: number, y: number}} = Object.freeze({
  X: {x: 1, y: 4},
  A: {x: 1, y: 8},
  B: {x: 0, y: 7},
  C: {x: 1, y: 6},
...
export const IdTable: {[key: number]: Mask} = {
  0: Mask.X, 1: Mask.A, 2: Mask.B, 4: Mask.C, 8: Mask.D,
  3: Mask.AB, 5: Mask.AC, 9: Mask.AD, 6: Mask.BC, 10: Mask.BD, 12: Mask.CD,
  7: Mask.ABC, 11: Mask.ABD, 13: Mask.ACD, 14: Mask.BCD, 15: Mask.ABCD,
  19: Mask.A1B, 38: Mask.B2C, 76: Mask.C3D, 137: Mask.AD4,
  23: Mask.A1BC, 39: Mask.AB2C, 46: Mask.B2CD, 78: Mask.BC3D,
  77: Mask.AC3D, 141: Mask.ACD4, 27: Mask.A1BD, 139: Mask.ABD4,
  55: Mask.A1B2C, 110: Mask.B2C3D, 205: Mask.AC3D4, 155: Mask.A1BD4,
  31: Mask.A1BCD, 47: Mask.AB2CD, 79: Mask.ABC3D, 143: Mask.ABCD4,
...
export const DungeonData: {[key in Dungeon]: DungeonInfo}  = Object.freeze({
  ...
  BARREN_VALLEY: {
    ...
    name: 'Barren Valley',
    pokemons: [],
    tileset: [Header.WALL, Header.WALL_ALT_1, Header.WALL_ALT_2, Header.GROUND, Header.GROUND_ALT_1, Header.GROUND_ALT_2, Header.GROUND_ALT_3, Header.WATER],
    type: Synergy.DARK
  },
  ...
  MYSTERY_JUNGLE_01F_15F: {
    ...
    tileset: [Header.WALL, Header.WALL_ALT_1, Header.WALL_ALT_2, Header.WALL_ALT_3, Header.GROUND, Header.GROUND_ALT_1, Header.GROUND_ALT_2, Header.GROUND_ALT_3, Header.WATER],
    type: Synergy.GRASS
  },
  ...
  BEACH_CAVE: {
    ...
    name: 'Beach Cave',
    pokemons: [Pkm.KABUTO],
    tileset: [Header.WALL, Header.WALL_ALT_1, Header.WALL_ALT_2, Header.GROUND, Header.GROUND_ALT_1, Header.GROUND_ALT_2, Header.GROUND_ALT_3, Header.GROUND_ALT_4, Header.WATER],
    type: Synergy.WATER
  },
  BOTTOMLESS_SEA: {
    id: 'BOTTOMLESS_SEA',
    ...
    tileset: [Header.WALL, Header.WALL_ALT_1, Header.WALL_ALT_2, Header.GROUND, Header.WATER],
    type: Synergy.WATER
  },
  BRINE_CAVE: {
    id: 'BRINE_CAVE',
  ...
  FROSTY_FOREST: {
    ...
    tileset: [Header.WALL, Header.WALL_ALT_1, Header.WALL_ALT_2, Header.GROUND, Header.GROUND_ALT_1, Header.WATER],
    type: Synergy.ICE
  },
  GREAT_CANYON: {
    id: 'GREAT_CANYON',
  ...
  POISON_MAZE: {
    ...
    tileset: [Header.WALL, Header.WALL_ALT_1, Header.GROUND, Header.GROUND_ALT_1, Header.GROUND_ALT_2, Header.GROUND_ALT_3, Header.WATER],
    type: Synergy.POISON
  },
