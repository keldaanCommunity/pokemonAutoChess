...
export const MusicByDungeon: Record<DungeonPMDO, DungeonMusic> = {
  ...
  [DungeonPMDO.DarkIceMountainPeak]: DungeonMusic.DARK_ICE_MOUNTAIN,
  ...
  [DungeonPMDO.DeepLimestoneCavern]: DungeonMusic.LIMESTONE_CAVERN,
  ...
  [DungeonPMDO.FutureTemporalSpire]: DungeonMusic.TEMPORAL_SPIRE,
  ...
  [DungeonPMDO.HowlingForest1]: DungeonMusic.FRIEND_AREA_FOREST,
  [DungeonPMDO.HowlingForest2]: DungeonMusic.FRIEND_AREA_FIELD,
  [DungeonPMDO.IceAegisCave]: DungeonMusic.AEGIS_CAVE,
  ...
  [DungeonPMDO.RockAegisCave]: DungeonMusic.AEGIS_CAVE,
  [DungeonPMDO.RockMaze]: DungeonMusic.DEFY_THE_LEGENDS,
  [DungeonPMDO.RockPathRB]: DungeonMusic.RISING_FEAR,
  [DungeonPMDO.RockPathTDS]: DungeonMusic.RISING_FEAR, // REUSED
  [DungeonPMDO.SealedRuin]: DungeonMusic.SEALED_RUIN_PIT,
  ...
  [DungeonPMDO.SteelAegisCave]: DungeonMusic.AEGIS_CAVE, // REUSED
  ...
  [DungeonPMDO.TemporalTower]: DungeonMusic.TEMPORAL_TOWER,
