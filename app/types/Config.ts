...
export enum DungeonPMDO {
  ...
  ChasmCave1 = "ChasmCave1",
  ChasmCave2 = "ChasmCave2",
  ...
  DrenchedBluffIsolated = "DrenchedBluffIsolated",
  ...
  TallGrass = "TallGrass",
  TallGrassBlue = "TallGrassBlue",
  TallGrassDark = "TallGrassDark",
  TallGrassWhite = "TallGrassWhite",
  TallGrassYellow = "TallGrassYellow",
