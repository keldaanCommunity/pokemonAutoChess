 ...
 export const EffectDescriptions = {
    ...
    [Effect.SWARM] : {
        'eng' : "At the start of combat, creates a copy of one bug pokemon",
        'esp' : "?NONE?",
        'fra' : "?NONE?" },
    [Effect.STICKY_WEB] : {
        'eng' : "At the start of combat, creates a copy of all bug pokemon",
        'esp' : "?NONE?",
        'fra' : "?NONE?" },
    [Effect.TAILWIND] : {
