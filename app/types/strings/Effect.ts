...
export const EffectDescription: {
  ...
  [Effect.STRENGTH]: {
    eng: "All allies adjacent to your Normal pokemon have +30 HP.",
  ...
  [Effect.SPORE]: {
    eng: "Grass allies restore 18 HP per second",
  ...
  [Effect.DRAGON_ENERGY]: {
    eng: "Your Dragon pokemon gain +5% attack Speed after every hit.",
