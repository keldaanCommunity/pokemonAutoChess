 ...
 export const EffectDescription: {[key in Effect]: {eng: string, esp: string, fra: string}} = {
     ...
     [Effect.VICTORY_STAR]:{
        'eng': 'Your Fire pokemon have 20% chance to burn ennemy for 2s on every hit and gain +1 Attack after every hit (Sunlight)',
        'esp': 'Fire pkm gana un 5% de dano en cada ataque',
        'fra': 'Les pkm feu gagnent 5% d\'ATK à chaque attaque'
     },
     [Effect.DROUGHT]: {
         'eng': 'Your Fire pokemon have 30% chance to burn ennemy for 2s on every hit and gain +2 Attack after every hit (Sunlight)',
     ...
     [Effect.DESOLATE_LAND]: {
         'eng': 'Your Fire pokemon have 40% chance to burn ennemy for 2s on every hit and gain +3 Attack after every hit (Sunlight)',
         'esp': '?NONE?',
         'fra': '?NONE?'
     },
     [Effect.RAIN_DANCE]: {
