...
export const SynergyDetail:{[key in Synergy]: Effect[]} = Object.freeze({
    ...
    [Synergy.WATER]: [Effect.DRIZZLE, Effect.RAIN_DANCE, Effect.PRIMORDIAL_SEA],
    ...
    [Synergy.METAL]: [Effect.AUTOTOMIZE, Effect.IRON_DEFENSE],
    ...
    [Synergy.FLYING]: [Effect.TAILWIND, Effect.FEATHER_DANCE, Effect.MAX_AIRSTREAM, Effect.MAX_GUARD],
    [Synergy.FLORA]: [Effect.ODD_FLOWER, Effect.GLOOM_FLOWER, Effect.VILE_FLOWER, Effect.SUN_FLOWER],
    [Synergy.MINERAL]: [Effect.BATTLE_ARMOR, Effect.MOUTAIN_RESISTANCE, Effect.DIAMOND_STORM],
    [Synergy.GHOST]: [Effect.PHANTOM_FORCE, Effect.CURSE],
    [Synergy.FAIRY]: [Effect.AROMATIC_MIST, Effect.FAIRY_WIND, Effect.STRANGE_STEAM],
