...
export const AbilityDescription: { [key in Ability]: Langage } = {
  ...
  [Ability.EARTHQUAKE]: {
    eng: "Deals damage 40/80/160 physical damage to all ennemy units in the same column/line",
    esp: "",
    fra: "",
    prt: ""
  },
  ...
  [Ability.GROWL]: {
    eng: "Apply wound status on the ennemy team for 3/6/9s",
    esp: "",
    fra: "",
    prt: ""
  },
  ...
  [Ability.POISON_STING]: {
    eng: "Physical mono target damage that deals 30/60/120. Doubles damage if target is poisoned.",
  ...
  [Ability.STEAM_ERUPTION]: {
    eng: "Deals 20/40/80 special damage around the target, and burning everything for 3s",
    esp: "",
    prt: "",
    fra: ""
  },
