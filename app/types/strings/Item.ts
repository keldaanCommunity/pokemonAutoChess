...
export const ItemDescription: { [key in Item]: string } = Object.freeze({
  ...
  [Item.SOUL_DEW]:
    "During combat, the holder gains 30% spell damage every 5 seconds",
  [Item.UPGRADE]: "Attacks grant +6% bonus Attack Speed for the rest of combat",
  [Item.REAPER_CLOTH]:
    "The holder spells can critically strike (20% chance, 2x damage)",
  [Item.POKEMONOMICON]:
    "When the holder deals damage with their Ability, they burn and wound the target for 2 seconds",
  [Item.WATER_INCENSE]:
    "When an ennemy cast an ability, they take incense damage equal to 20% of their max mana",
  [Item.SHELL_BELL]: "The holder spells heal for 40% of the damage dealt",
  [Item.LUCKY_EGG]:
    "When combat begins, the holder and all allies within 2 hexes in the same row gain 20 shield points",
  [Item.AQUA_EGG]:
    "The holder gains 50 mana. After casting their ability the holder gains 20 mana",
  [Item.BLUE_ORB]:
    "The holder gains 10% bonus Attack Speed. Every third attack from the holder unleashes a chain lightning that bounces to 4 enemies, dealing 8 magic damage",
  [Item.ZOOM_LENS]: "The holder gains 4 attack damage and 40% spell damage",
  [Item.BRIGHT_POWDER]:
    "Every 5 seconds, the holder throws a bright powder within 1 hex, healing them for 18% of their missing health",
  [Item.DELTA_ORB]:
    "When combat begins, the holder and all allies within 1 hex in the same row gain 30% Spell damage for the rest of combat",
  ...
  [Item.LEFTOVERS]:
    "During  the combat, the holder attack heals adjacent allies for 3 health point",
  [Item.CHOICE_SCARF]:
    "The holder basic attack hit a second adjacent ennemy for 75% of holder damage",
  [Item.FIRE_GEM]:
    "The holders Abilities and attacks do 20% bonus damage. If the target has more than 200 maximum Health, the bonus increases to 60%.",
  [Item.DEFENSIVE_RIBBON]:
    "When the holder takes damage, they gain attack damage, 1 defense and 1 special defense. Stacks up to 5 times",
  [Item.WONDER_BOX]:
    "At the beginning of each battle phase, the holder equips 2 temporary items",
  [Item.RUNE_PROTECT]:
    "When combat begins, the holder and all adjacent allies are immune to spells for the first 8 seconds",
  [Item.WIDE_LENS]:
    "The holder gains 20% bonus attack speed. The holder is immune to poison/fire",
  [Item.RAZOR_CLAW]:
    "The holder gains 75% Critical Strike Chance and 10% Critical Strike Damage",
