...
export const ItemName: { [key in Item]: string } = {
  ...
  [Item.GRACIDEA_FLOWER]: "Gracidea Flower",
...
export const ItemDescription: { [key in Item]: string } = Object.freeze({
  ...
  [Item.LUCKY_EGG]: `+40% ${Stat.AP} for holder and adjacent allies in the same row`,
  ...
  [Item.RED_ORB]: `+10 ${Stat.ATK}. 25% of attack damage is dealt as ${Damage.TRUE}`,
