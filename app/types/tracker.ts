...
//
//   const tracker = Convert.toTracker(json);
//
...
export interface Tracker {
    ...
    subgroups:             { [key: string]: TrackerSubgroup };
}
...
export interface TrackerSubgroup {
    canon:                 boolean;
    modreward:             boolean;
    name:                  string;
    portrait_bounty:       { [key: string]: number };
...
export class Convert {
    public static toTracker(json: string): { [key: string]: Tracker } {
        return cast(JSON.parse(json), m(r("Tracker")));
    }

    public static trackerToJson(value: { [key: string]: Tracker }): string {
        return JSON.stringify(uncast(value, m(r("Tracker"))), null, 2);
    }
}
...
const typeMap: any = {
    "Tracker": o([
        ...
        { json: "subgroups", js: "subgroups", typ: m(r("TrackerSubgroup")) },
    ], false),
    "Credit": o([
