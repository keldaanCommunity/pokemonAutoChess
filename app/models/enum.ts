...
export const AUTHOR = {
  ...
  meditite: 'Nintendo',
  medicham: 'Nintendo',
  'mega-medicham': 'Juanca',
  numel: 'Nintendo',
  camerupt: 'Nintendo',
  'mega-camerupt': 'Phoenix',
  sandshrew: 'Nintendo',
  sandslash: 'Nintendo',
  darkrai: 'Nintendo',
  litwick: 'PowerCrystal',
  lampent: 'PowerCrystal',
  chandelure: 'PowerCrystal',
  slowpoke: 'Nintendo',
  slowbro: 'Nintendo',
  slowking: 'Nintendo',
  bellsprout: 'Nintendo',
  ...
  snover: 'Nintendo',
  abomasnow: 'Nintendo',
  'mega-abomasnow': 'phoenix',
  vanillite: 'Nintendo',
  vanillish: 'Nintendo',
  vanilluxe: 'Nintendo',
  glaceon: 'Nintendo',
  volcarona: 'PowerCrystal',
  landorus: 'PowerCrystal',
  thundurus: 'PowerCrystal',
  tornadus: 'PowerCrystal',
  keldeo: 'PowerCrystal',
  terrakion: 'PowerCrystal',
  virizion: 'PowerCrystal',
  cobalion: 'PowerCrystal',
  manaphy: 'Nintendo',
  rotom: 'Nintendo',
  spiritomb: 'Nintendo',
  absol: 'Nintendo',
  ...
  mewtwo: 'Nintendo',
  kyurem: 'PowerCrystal',
  reshiram: 'PowerCrystal',
  zekrom: 'PowerCrystal',
  celebi: 'Nintendo',
  victini: 'PowerCrystal',
  jirachi: 'Nintendo',
  arceus: 'Nintendo',
  deoxys: 'Nintendo',
  shaymin: 'Nintendo',
  ...
  'ho-Oh': 'Nintendo',
  aerodactyl: 'Nintendo',
  'primal-Kyogre': 'Keldaan',
  'primal-Groudon': 'Keldaan',
  meowth: 'Nintendo',
  persian: 'Nintendo',
  deino: 'PowerCrystal',
  zweilous: 'PowerCrystal',
  hydreigon: 'PowerCrystal',
  sandile: 'PowerCrystal',
  krokorok: 'PowerCrystal',
  krookodile: 'PowerCrystal',
  solosis: 'PowerCrystal',
  duosion: 'PowerCrystal',
  reuniclus: 'PowerCrystal',
  'mega-Rayquaza': 'academico95',
  swablu: 'Nintendo',
  oddish: 'Nintendo',
  gloom: 'Nintendo',
  vileplume: 'Nintendo',
  ...
  omastar: 'Nintendo',
  tyrunt: 'NeroIntruder',
  tyrantrum: 'NeroIntruder',
  budew: 'Nintendo',
  roselia: 'Nintendo',
  roserade: 'Nintendo',
  buneary: 'Nintendo',
  lopunny: 'Nintendo',
  'mega-lopunny': 'PMDCollab',
  axew: 'PowerCrystal',
  fraxure: 'PowerCrystal',
  haxorus: 'PowerCrystal',
  venipede: 'Nintendo',
  whirlipede: 'Nintendo',
  scolipede: 'Nintendo',
  porygon: 'Nintendo',
  ...
  klink: 'Joojishibuki',
  klang: 'Joojishibuki',
  klinklang: 'Joojishibuki',
  electrike: 'Nintendo',
  manectric: 'Nintendo',
  'mega-manectric': 'Nintendo',
  shuppet: 'Nintendo',
  banette: 'Nintendo',
  'mega-banette': 'Junaca',
  honedge: 'PmdCollab',
  doublade: 'pokegirl4ever',
  aegislash: 'jhony rex',
  cubone: 'Nintendo',
  marowak: 'Nintendo',
  'alolan-marowak': 'Nintendo',
  fletchling: 'Nintendo',
  fletchinder: 'Nintendo',
  talonflame: 'Nintendo',
  whismur: 'Nintendo',
  loudred: 'Nintendo',
  exploud: 'Nintendo',
  ...
  floette: 'PmdCollab',
  florges: 'PmdCollab',
  'jangmo-o': 'princess phoenix',
  'hakamo-o': 'princess phoenix',
  'kommo-o': 'princess phoenix',
  meloetta: 'Nintendo',
  altaria: 'Nintendo',
  'mega-altaria': 'Nintendo',
  lillipup: 'princess phoenix',
  herdier: 'princess phoenix',
  stoutland: 'princess phoenix',
  hitmonchan: 'Nintendo',
  skuntank: 'Nintendo',
  primeape: 'Nintendo',
  ursaring: 'Nintendo',
  ...
  arbok: 'Nintendo',
  castform: 'Nintendo',
  'castform-sun': 'Nintendo',
  'castform-rain': 'Nintendo',
  'castform-hail': 'Nintendo'
};