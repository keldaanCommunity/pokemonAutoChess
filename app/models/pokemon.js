...
class Scyther extends Pokemon {
  constructor() {
    super('scyther', [TYPE.BUG, TYPE.NORMAL], RARITY.LEGENDARY, 123, 'scizor', 90, 5, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Scizor extends Pokemon {
  constructor() {
    super('scizor', [TYPE.BUG, TYPE.METAL], RARITY.LEGENDARY, 212, 'mega-scizor', 130, 9, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class MegaScizor extends Pokemon {
  constructor() {
    super('mega-scizor', [TYPE.BUG, TYPE.METAL], RARITY.LEGENDARY, 2120, '', 230, 16, 2, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Onix extends Pokemon {
  constructor() {
    super('onix', [TYPE.MINERAL, TYPE.GROUND], RARITY.LEGENDARY, 95, 'steelix', 90, 5, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Steelix extends Pokemon {
  constructor() {
    super('steelix', [TYPE.MINERAL, TYPE.GROUND, TYPE.METAL], RARITY.LEGENDARY, 208, 'mega-steelix', 130, 9, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class MegaSteelix extends Pokemon {
  constructor() {
    super('mega-steelix', [TYPE.MINERAL, TYPE.GROUND, TYPE.METAL], RARITY.LEGENDARY, 2080, '', 230, 16, 5, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Growlithe extends Pokemon {
  constructor() {
    super('growlithe', [TYPE.FIRE, TYPE.FIELD], RARITY.LEGENDARY, 58, 'arcanine', 90, 9, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Arcanine extends Pokemon {
  constructor() {
    super('arcanine', [TYPE.FIRE, TYPE.FIELD], RARITY.LEGENDARY, 59, '', 130, 16, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Numel extends Pokemon{
  constructor(){
    super('numel',[TYPE.FIRE,TYPE.FIELD,TYPE.GROUND], RARITY.LEGENDARY, 322, 'camerupt', 90, 5, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Camerupt extends Pokemon{
  constructor(){
    super('camerupt',[TYPE.FIRE,TYPE.FIELD,TYPE.GROUND], RARITY.LEGENDARY, 323, 'mega-camerupt', 130, 9, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class MegaCamerupt extends Pokemon{
  constructor(){
  super('mega-camerupt',[TYPE.FIRE,TYPE.FIELD,TYPE.GROUND], RARITY.LEGENDARY, 3230, '', 230, 16, 3, 3, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Munchlax extends Pokemon {
  constructor() {
    super('munchlax', [TYPE.NORMAL, TYPE.HUMAN], RARITY.LEGENDARY, 446, 'snorlax', 90, 9, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Snorlax extends Pokemon {
  constructor() {
    super('snorlax', [TYPE.NORMAL, TYPE.HUMAN], RARITY.LEGENDARY, 143, '', 130, 16, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Medicham extends Pokemon{
  constructor(){
    super('medicham', [TYPE.NORMAL, TYPE.HUMAN, TYPE.FIGHTING], RARITY.LEGENDARY, 308, 'mega-medicham', 130, 9, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class MegaMedicham extends Pokemon{
  constructor(){
    super('mega-medicham', [TYPE.NORMAL, TYPE.HUMAN, TYPE.FIGHTING], RARITY.LEGENDARY, 3080, '', 230, 16, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Elekid extends Pokemon {
  constructor() {
    super('elekid', [TYPE.ELECTRIC, TYPE.HUMAN], RARITY.EPIC, 239, 'electabuzz', 90, 5, 1, 1, 1, 'ELECTRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Electabuzz extends Pokemon {
  constructor() {
    super('electabuzz', [TYPE.ELECTRIC, TYPE.HUMAN], RARITY.EPIC, 125, 'electivire', 130, 9, 1, 1, 1, 'ELECTRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Electivire extends Pokemon {
  constructor() {
    super('electivire', [TYPE.ELECTRIC, TYPE.HUMAN], RARITY.EPIC, 466, '', 230, 16, 1, 1, 1, 'ELECTRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Gible extends Pokemon {
  constructor() {
    super('gible', [TYPE.DRAGON, TYPE.GROUND, TYPE.MONSTER], RARITY.EPIC, 443, 'gabite', 90, 5, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Gabite extends Pokemon {
  constructor() {
    super('gabite', [TYPE.DRAGON, TYPE.GROUND, TYPE.MONSTER], RARITY.EPIC, 444, 'garchomp', 130, 9, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Garchomp extends Pokemon {
  constructor() {
    super('garchomp', [TYPE.DRAGON, TYPE.GROUND, TYPE.MONSTER], RARITY.EPIC, 445, '', 230, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Beldum extends Pokemon {
  constructor() {
    super('beldum', [TYPE.PSYCHIC, TYPE.METAL, TYPE.MINERAL], RARITY.EPIC, 374, 'metang', 90, 5, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Metang extends Pokemon {
  constructor() {
    super('metang', [TYPE.PSYCHIC, TYPE.METAL, TYPE.MINERAL], RARITY.EPIC, 375, 'metagross', 130, 9, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Metagross extends Pokemon {
  constructor() {
    super('metagross', [TYPE.PSYCHIC, TYPE.METAL, TYPE.MINERAL], RARITY.EPIC, 376, '', 230, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Slakoth extends Pokemon {
  constructor() {
    super('slakoth', [TYPE.NORMAL, TYPE.HUMAN], RARITY.EPIC, 287, 'vigoroth', 90, 5, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Vigoroth extends Pokemon {
  constructor() {
    super('vigoroth', [TYPE.NORMAL, TYPE.HUMAN], RARITY.EPIC, 288, 'slaking', 130, 9, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Slaking extends Pokemon {
  constructor() {
    super('slaking', [TYPE.NORMAL, TYPE.HUMAN], RARITY.EPIC, 289, '', 230, 16, 1, 1, 1, 'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Larvitar extends Pokemon {
  constructor() {
    super('larvitar', [TYPE.DARK, TYPE.MONSTER], RARITY.EPIC, 246, 'pupitar', 90, 8, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Pupitar extends Pokemon {
  constructor() {
    super('pupitar', [TYPE.DARK, TYPE.MONSTER], RARITY.EPIC, 247, 'tyranitar', 130, 9, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Tyranitar extends Pokemon {
  constructor() {
    super('tyranitar', [TYPE.DARK, TYPE.MONSTER], RARITY.EPIC, 248, '', 230, 16, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Dratini extends Pokemon {
  constructor() {
    super('dratini', [TYPE.DRAGON, TYPE.AQUATIC], RARITY.EPIC, 147, 'dragonair', 90, 5, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Dragonair extends Pokemon {
  constructor() {
    super('dragonair', [TYPE.DRAGON, TYPE.AQUATIC], RARITY.EPIC, 148, 'dragonite', 130, 9, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Dragonite extends Pokemon {
  constructor() {
    super('dragonite', [TYPE.DRAGON, TYPE.AQUATIC], RARITY.EPIC, 149, '', 230, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Shinx extends Pokemon {
  constructor() {
    super('shinx', [TYPE.ELECTRIC, TYPE.FIELD], RARITY.RARE, 403, 'luxio', 80, 5, 1, 1, 1, 'ELECTRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Luxio extends Pokemon {
  constructor() {
    super('luxio', [TYPE.ELECTRIC, TYPE.FIELD], RARITY.RARE, 404, 'luxray', 120, 9, 1, 1, 1, 'ELECTRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Luxray extends Pokemon {
  constructor() {
    super('luxray', [TYPE.ELECTRIC, TYPE.FIELD], RARITY.RARE, 405, '', 220, 16, 1, 1, 1, 'ELECTRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Rhyhorn extends Pokemon {
  constructor() {
    super('rhyhorn', [TYPE.GROUND, TYPE.MONSTER], RARITY.RARE, 111, 'rhydon', 80, 5, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Rhydon extends Pokemon {
  constructor() {
    super('rhydon', [TYPE.GROUND, TYPE.MONSTER], RARITY.RARE, 112, 'rhyperior', 120, 9, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Rhyperior extends Pokemon {
  constructor() {
    super('rhyperior', [TYPE.GROUND, TYPE.MONSTER], RARITY.RARE, 464, '', 220, 16, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Aron extends Pokemon {
  constructor() {
    super('aron', [TYPE.METAL, TYPE.MONSTER], RARITY.RARE, 304, 'lairon', 80, 5, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Lairon extends Pokemon {
  constructor() {
    super('lairon', [TYPE.METAL, TYPE.MONSTER], RARITY.RARE, 305, 'aggron', 120, 9, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Aggron extends Pokemon {
  constructor() {
    super('aggron', [TYPE.METAL, TYPE.MONSTER], RARITY.RARE, 306, '', 220, 16, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Spheal extends Pokemon {
  constructor() {
    super('spheal', [TYPE.WATER, TYPE.FIELD], RARITY.RARE, 363, 'sealeo', 80, 5, 1, 1, 1, 'ICE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Sealeo extends Pokemon {
  constructor() {
    super('sealeo', [TYPE.WATER, TYPE.FIELD], RARITY.RARE, 364, 'walrein', 120, 9, 1, 1, 1, 'ICE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Walrein extends Pokemon {
  constructor() {
    super('walrein', [TYPE.WATER, TYPE.FIELD], RARITY.RARE, 365, '', 220, 16, 1, 1, 1, 'ICE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Trapinch extends Pokemon {
  constructor() {
    super('trapinch', [TYPE.GROUND, TYPE.BUG], RARITY.RARE, 328, 'vibrava', 80, 5, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Vibrava extends Pokemon {
  constructor() {
    super('vibrava', [TYPE.GROUND, TYPE.DRAGON, TYPE.BUG], RARITY.RARE, 329, 'flygon', 120, 9, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Flygon extends Pokemon {
  constructor() {
    super('flygon', [TYPE.GROUND, TYPE.DRAGON, TYPE.BUG], RARITY.RARE, 330, '', 220, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Machop extends Pokemon {
  constructor() {
    super('machop', [TYPE.FIGHTING, TYPE.HUMAN], RARITY.RARE, 66, 'machoke', 80, 5, 1, 1, 1, 'FIGHTING/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Machoke extends Pokemon {
  constructor() {
    super('machoke', [TYPE.FIGHTING, TYPE.HUMAN], RARITY.RARE, 67, 'machamp', 120, 9, 1, 1, 1, 'FIGHTING/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Machamp extends Pokemon {
  constructor() {
    super('machamp', [TYPE.FIGHTING, TYPE.HUMAN], RARITY.RARE, 68, '', 220, 16, 1, 1, 1, 'FIGHTING/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class NidoranF extends Pokemon {
  constructor() {
    super('nidoranF', [TYPE.POISON, TYPE.FIELD], RARITY.UNCOMMON, 29, 'nidorina', 70, 5, 1, 1, 1, 'POISON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Nidorina extends Pokemon {
  constructor() {
    super('nidorina', [TYPE.POISON, TYPE.FIELD], RARITY.UNCOMMON, 30, 'nidoqueen', 120, 9, 1, 1, 1, 'POISON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Nidoqueen extends Pokemon {
  constructor() {
    super('nidoqueen', [TYPE.POISON, TYPE.FIELD], RARITY.UNCOMMON, 31, '', 210, 16, 1, 1, 1, 'POISON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class NidoranM extends Pokemon {
  constructor() {
    super('nidoranM', [TYPE.POISON, TYPE.FIELD], RARITY.UNCOMMON, 32, 'nidorino', 70, 5, 1, 1, 1, 'POISON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Nidorino extends Pokemon {
  constructor() {
    super('nidorino', [TYPE.POISON, TYPE.FIELD], RARITY.UNCOMMON, 33, 'nidoking', 120, 9, 1, 1, 1, 'POISON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Nidoking extends Pokemon {
  constructor() {
    super('nidoking', [TYPE.POISON, TYPE.FIELD], RARITY.UNCOMMON, 34, '', 210, 16, 1, 1, 1, 'POISON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Piplup extends Pokemon {
  constructor() {
    super('piplup', [TYPE.WATER, TYPE.FLYING], RARITY.UNCOMMON, 393, 'prinplup', 70, 5, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Prinplup extends Pokemon {
  constructor() {
    super('prinplup', [TYPE.WATER, TYPE.FLYING, TYPE.METAL], RARITY.UNCOMMON, 394, 'empoleon', 120, 9, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Empoleon extends Pokemon {
  constructor() {
    super('empoleon', [TYPE.WATER, TYPE.FLYING, TYPE.METAL], RARITY.UNCOMMON, 395, '', 210, 16, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Chimchar extends Pokemon {
  constructor() {
    super('chimchar', [TYPE.FIRE, TYPE.HUMAN], RARITY.UNCOMMON, 390, 'monferno', 70, 5, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Monferno extends Pokemon {
  constructor() {
    super('monferno', [TYPE.FIRE, TYPE.HUMAN, TYPE.FIGHTING], RARITY.UNCOMMON, 391, 'infernape', 120, 9, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Infernape extends Pokemon {
  constructor() {
    super('infernape', [TYPE.FIRE, TYPE.HUMAN, TYPE.FIGHTING], RARITY.UNCOMMON, 392, '', 210, 16, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Turtwig extends Pokemon {
  constructor() {
    super('turtwig', [TYPE.GRASS, TYPE.GROUND, TYPE.FLORA], RARITY.UNCOMMON, 387, 'grotle', 70, 5, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Grotle extends Pokemon {
  constructor() {
    super('grotle', [TYPE.GRASS, TYPE.GROUND, TYPE.FLORA], RARITY.UNCOMMON, 388, 'torterra', 120, 9, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Torterra extends Pokemon {
  constructor() {
    super('torterra', [TYPE.GRASS, TYPE.GROUND, TYPE.FLORA], RARITY.UNCOMMON, 389, '', 210, 16, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Mudkip extends Pokemon {
  constructor() {
    super('mudkip', [TYPE.WATER, TYPE.GROUND], RARITY.UNCOMMON, 258, 'marshtomp', 70, 5, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Marshtomp extends Pokemon {
  constructor() {
    super('marshtomp', [TYPE.WATER, TYPE.GROUND], RARITY.UNCOMMON, 259, 'swampert', 120, 9, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Swampert extends Pokemon {
  constructor() {
    super('swampert', [TYPE.WATER, TYPE.GROUND], RARITY.UNCOMMON, 260, '', 210, 16, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Torchic extends Pokemon {
  constructor() {
    super('torchic', [TYPE.FIRE, TYPE.FLYING], RARITY.UNCOMMON, 255, 'combusken', 70, 5, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Combusken extends Pokemon {
  constructor() {
    super('combusken', [TYPE.FIRE, TYPE.FIGHTING, TYPE.FLYING], RARITY.UNCOMMON, 256, 'blaziken', 120, 9, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Blaziken extends Pokemon {
  constructor() {
    super('blaziken', [TYPE.FIRE, TYPE.FIGHTING, TYPE.FLYING], RARITY.UNCOMMON, 257, '', 210, 16, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Treecko extends Pokemon {
  constructor() {
    super('treecko', [TYPE.GRASS, TYPE.MONSTER], RARITY.UNCOMMON, 252, 'grovyle', 70, 5, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Grovyle extends Pokemon {
  constructor() {
    super('grovyle', [TYPE.GRASS, TYPE.MONSTER], RARITY.UNCOMMON, 253, 'sceptile', 120, 9, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Sceptile extends Pokemon {
  constructor() {
    super('sceptile', [TYPE.GRASS, TYPE.MONSTER], RARITY.UNCOMMON, 254, '', 210, 16, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Totodile extends Pokemon {
  constructor() {
    super('totodile', [TYPE.WATER, TYPE.AQUATIC], RARITY.UNCOMMON, 158, 'croconaw', 70, 5, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Croconaw extends Pokemon {
  constructor() {
    super('croconaw', [TYPE.WATER, TYPE.AQUATIC], RARITY.UNCOMMON, 159, 'feraligatr', 120, 9, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Feraligatr extends Pokemon {
  constructor() {
    super('feraligatr', [TYPE.WATER, TYPE.AQUATIC], RARITY.UNCOMMON, 160, '', 210, 16, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Charmander extends Pokemon {
  constructor() {
    super('charmander', [TYPE.FIRE, TYPE.MONSTER], RARITY.UNCOMMON, 4, 'charmeleon', 70, 5, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Charmeleon extends Pokemon {
  constructor() {
    super('charmeleon', [TYPE.FIRE, TYPE.MONSTER], RARITY.UNCOMMON, 5, 'charizard', 120, 9, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Charizard extends Pokemon {
  constructor() {
    super('charizard', [TYPE.FIRE, TYPE.MONSTER], RARITY.UNCOMMON, 6, '', 210, 16, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Geodude extends Pokemon {
  constructor() {
    super('geodude', [TYPE.GROUND, TYPE.MINERAL], RARITY.COMMON, 74, 'graveler', 60, 5, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Graveler extends Pokemon {
  constructor() {
    super('graveler', [TYPE.GROUND, TYPE.MINERAL], RARITY.COMMON, 75, 'golem', 110, 9, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Golem extends Pokemon {
  constructor() {
    super('golem', [TYPE.GROUND, TYPE.MINERAL], RARITY.COMMON, 76, '', 200, 16, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Cleffa extends Pokemon {
  constructor() {
    super('cleffa', [TYPE.FAIRY, TYPE.NORMAL], RARITY.COMMON, 173, 'clefairy', 60, 5, 1, 1, 1, 'FAIRY/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Clefairy extends Pokemon {
  constructor() {
    super('clefairy', [TYPE.FAIRY, TYPE.NORMAL], RARITY.COMMON, 35, 'clefable', 110, 9, 1, 1, 1, 'FAIRY/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Clefable extends Pokemon {
  constructor() {
    super('clefable', [TYPE.FAIRY, TYPE.NORMAL], RARITY.COMMON, 36, '', 200, 16, 1, 1, 1, 'FAIRY/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Weedle extends Pokemon {
  constructor() {
    super('weedle', [TYPE.POISON, TYPE.BUG], RARITY.COMMON, 13, 'kakuna', 60, 5, 1, 1, 1, 'BUG/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Kakuna extends Pokemon {
  constructor() {
    super('kakuna', [TYPE.POISON, TYPE.BUG], RARITY.COMMON, 14, 'beedrill', 110, 9, 1, 1, 1, 'BUG/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Beedrill extends Pokemon {
  constructor() {
    super('beedrill', [TYPE.POISON, TYPE.BUG], RARITY.COMMON, 15, '', 200, 16, 1, 1, 1, 'BUG/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Seedot extends Pokemon {
  constructor() {
    super('seedot', [TYPE.GRASS, TYPE.DARK, TYPE.FIELD], RARITY.COMMON, 273, 'nuzleaf', 60, 5, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Nuzleaf extends Pokemon {
  constructor() {
    super('nuzleaf', [TYPE.GRASS, TYPE.DARK, TYPE.FIELD], RARITY.COMMON, 274, 'shiftry', 110, 9, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Shiftry extends Pokemon {
  constructor() {
    super('shiftry', [TYPE.GRASS, TYPE.DARK, TYPE.FIELD], RARITY.COMMON, 275, '', 200, 16, 1, 1, 1, 'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Starly extends Pokemon {
  constructor() {
    super('starly', [TYPE.NORMAL, TYPE.FLYING], RARITY.COMMON, 396, 'staravia', 60, 5, 1, 1, 1, 'FLYING/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Staravia extends Pokemon {
  constructor() {
    super('staravia', [TYPE.NORMAL, TYPE.FLYING], RARITY.COMMON, 397, 'staraptor', 110, 9, 1, 1, 1, 'FLYING/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Staraptor extends Pokemon {
  constructor() {
    super('staraptor', [TYPE.NORMAL, TYPE.FLYING], RARITY.COMMON, 398, '', 200, 16, 1, 1, 1, 'FLYING/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Lugia extends Pokemon {
  constructor() {
    super('lugia', [], RARITY.NEUTRAL, 249, '', 250, 16, 1, 1, 4, 'FLYING/range', ATTACK_TYPE.SPECIAL);
  }
}

class Giratina extends Pokemon {
  constructor() {
    super('lugia', [], RARITY.NEUTRAL, 487, '', 250, 16, 1, 1, 3, 'GHOST/range', ATTACK_TYPE.SPECIAL);
  }
}

class Zapdos extends Pokemon {
  constructor() {
    super('zapdos', [], RARITY.NEUTRAL, 145, '', 250, 16, 1, 1, 3, 'ELECTRIC/range', ATTACK_TYPE.SPECIAL);
  }
}

class Moltres extends Pokemon {
  constructor() {
    super('moltres', [], RARITY.NEUTRAL, 146, '', 250, 16, 1, 1, 3, 'FIRE/range', ATTACK_TYPE.SPECIAL);
  }
}

class Articuno extends Pokemon {
  constructor() {
    super('articuno', [], RARITY.NEUTRAL, 144, '', 250, 16, 1, 1, 3, 'FLYING/range', ATTACK_TYPE.SPECIAL);
  }
}

class Dialga extends Pokemon {
  constructor() {
    super('dialga', [], RARITY.NEUTRAL, 483, '', 250, 16, 1, 1, 3, 'FIGHTING/range', ATTACK_TYPE.SPECIAL);
  }
}

class Palkia extends Pokemon {
  constructor() {
    super('palkia', [], RARITY.NEUTRAL, 484, '', 250, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Suicune extends Pokemon {
  constructor() {
    super('suicune', [], RARITY.NEUTRAL, 245, '', 250, 16, 1, 1, 1, 'WATER/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Raikou extends Pokemon {
  constructor() {
    super('raikou', [], RARITY.NEUTRAL, 243, '', 250, 16, 1, 1, 1, 'ELETRIC/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Entei extends Pokemon {
  constructor() {
    super('entei', [], RARITY.NEUTRAL, 244, '', 250, 16, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Regice extends Pokemon {
  constructor() {
    super('regice', [], RARITY.NEUTRAL, 378, '', 250, 16, 1, 1, 1, 'ICE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Regirock extends Pokemon {
  constructor() {
    super('regirock', [], RARITY.NEUTRAL, 377, '', 250, 16, 1, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Registeel extends Pokemon {
  constructor() {
    super('registeel', [], RARITY.NEUTRAL, 379, '', 250, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Regigigas extends Pokemon {
  constructor() {
    super('regigigas', [], RARITY.NEUTRAL, 486, '', 250, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Kyogre extends Pokemon {
  constructor() {
    super('kyogre', [TYPE.WATER, TYPE.AQUATIC], RARITY.NEUTRAL, 382, '', 250, 16, 1, 1, 4, 'WATER/range', ATTACK_TYPE.SPECIAL);
  }
}

class Groudon extends Pokemon {
  constructor() {
    super('groudon', [], RARITY.NEUTRAL, 383, '', 250, 16, 1, 1, 1, 'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Rayquaza extends Pokemon {
  constructor() {
    super('rayquaza', [], RARITY.NEUTRAL, 384, '', 250, 16, 1, 1, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Eevee extends Pokemon{
  constructor(){
    super('eevee',[TYPE.NORMAL, TYPE.FIELD],RARITY.UNCOMMON,133,'',130,5,1,1,1,'NORMAL/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Flareon extends Pokemon{
  constructor(){
    super('flareon',[TYPE.FIRE, TYPE.FIELD],RARITY.UNCOMMON,136,'',130,3,1,1,1,'FIRE/melee', ATTACK_TYPE.PHYSICAL);
  }
}
...
class Umbreon extends Pokemon{
  constructor(){
    super('umbreon',[TYPE.DARK, TYPE.FIELD],RARITY.UNCOMMON,197,'',130,9,1,1,1,'DRAGON/melee', ATTACK_TYPE.PHYSICAL);
  }
}

class Leafon extends Pokemon{
  constructor(){
    super('leafon',[TYPE.GRASS, TYPE.FLORA, TYPE.FIELD],RARITY.UNCOMMON,470,'',130,9,1,1,1,'GRASS/melee', ATTACK_TYPE.PHYSICAL);
  }
}
