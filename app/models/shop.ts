...
const RARE = [Pkm.BULBASAUR, Pkm.TURTWIG, Pkm.NIDORANF,
  ...
  Pkm.DRATINI, Pkm.MAGBY, Pkm.WHISMUR, Pkm.PUMPKABOO, Pkm.MAKUHITA, Pkm.JOLTIK];
...
const MYTHICAL_1 = [Pkm.DIANCIE, Pkm.REGIDRAGO, Pkm.REGIELEKI, Pkm.CASTFORM, Pkm.VIRIZION, Pkm.REGICE, Pkm.REGISTEEL, Pkm.REGIROCK, Pkm.UXIE, Pkm.MESPRIT, Pkm.AZELF, Pkm.LATIAS, Pkm.LATIOS, Pkm.ZAPDOS, Pkm.MOLTRES, Pkm.ARTICUNO, Pkm.LAPRAS, Pkm.ABSOL, Pkm.SPIRITOMB, Pkm.ROTOM, Pkm.MANAPHY, Pkm.COBALION, Pkm.TERRAKION, Pkm.KELDEO, Pkm.TORNADUS, Pkm.THUNDURUS, Pkm.LANDORUS, Pkm.VOLCARONA];
