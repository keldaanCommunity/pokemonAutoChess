import { Abomasnow, Abra, Absol, Aegislash, Aerodactyl, Aggron, Alakazam, AlolanMarowak, Altaria, Amaura, Ampharos, Anorith, Arcanine, Arceus, Archen, Archeops, Armaldo, Aron, Articuno, Aurorus, Axew, Azelf, Azumarill, Azurill, Bagon, Banette, Bastiodon, Bayleef, Beedrill, Beldum, Bellossom, Bellsprout, Blacephalon, Blastoise, Blaziken, Blissey, Braixen, Budew, Bulbasaur, Buneary, Butterfree, Cacnea, Cacturne, Camerupt, Carracosta, Carvanha, Castform, CastformHail, CastformRain, CastformSun, Caterpie, Celebi, Chandelure, Chansey, Charizard, Charmander, Charmeleon, Chikorita, Chimchar, Clamperl, Clefable, Clefairy, Cleffa, Cobalion, Combusken, Corphish, Cradily, Cranidos, Crawdaunt, Cresselia, Crobat, Croconaw, Cubone, Cyndaquil, Darkrai, Deino, Delphox, Deoxys, Dialga, Diancie, Ditto, Doublade, Dragonair, Dragonite, Dratini, Duosion, Dusclops, Dusknoir, Duskull, Eevee, Electabuzz, Electivire, Electrike, Elekid, Empoleon, Entei, Espeon, Eternatus, Exploud, Fearow, Fennekin, Feraligatr, Flabebe, Flaffy, Flareon, Floette, Florges, Flygon, Fraxure, Froslass, Gabite, Galvantula, Garchomp, Gardevoir, Gastly, Genesect, Gengar, Geodude, Gible, Giratina, Glaceon, Glalie, Gloom, Golbat, Golem, Gorebyss, Gourgeist, Graveler, Grotle, Groudon, Grovyle, Growlithe, Guzzlord, Gyarados, HakamoO, Happiny, Hariyama, Hatenna, Hatterene, Hattrem, Haunter, Haxorus, Heatran, Honedge, HooH, Hoppip, Horsea, Houndoom, Houndour, Huntail, Hydreigon, Igglybuff, Infernape, Ivysaur, JangmoO, Jigglypuff, Jirachi, Jolteon, Joltik, Jumpluff, Kabuto, Kabutops, Kadabra, Kakuna, Keldeo, Kingdra, Kirlia, KommoO, Krookodile, Krookorok, Kyogre, Kyurem, Lairon, Lampent, Landorus, Lapras, Larvitar, Latias, Latios, Leafeon, Leavanny, Lileep, Litwick, Lombre, Lopunny, Lotad, Loudred, Lucario, Ludicolo, Lugia, Luxio, Luxray, Machamp, Machoke, Machop, Magby, Magikarp, Magmar, Magmortar, Magnemite, Magneton, Magnezone, Makuhita, Mamoswine, Manaphy, Manectric, Mareep, Marill, Marowak, Marshtomp, Medicham, Meditite, MegaAbomasnow, MegaAltaria, MegaBanette, MegaCamerupt, MegaHoundoom, MegaLopunny, MegaLucario, MegaManectric, MegaMedicham, Meganium, MegaRayquaza, MegaScizor, MegaSteelix, Meloetta, Meowth, Mesprit, Metagross, Metang, Metapod, Mewtwo, Moltres, Monferno, Mudkip, Munchlax, Nidoking, Nidoqueen, NidoranF, NidoranM, Nidorina, Nidorino, Nincada, Ninjask, Noibat, Noivern, Numel, Nuzleaf, Oddish, Omanyte, Omastar, Onix, Palkia, Palpitoad, Persian, Pichu, Pidgeot, Pidgeotto, Pidgey, Pikachu, Pikipek, Piloswine, Piplup, Pokemon, Politoed, Poliwag, Poliwhirl, Ponyta, Porygon, Porygon2, PorygonZ, PrimalGroudon, PrimalKyogre, Prinplup, Pumpkaboo, Pupitar, Quilava, Raichu, Raikou, Ralts, Rampardos, Rapidash, Raticate, Rattata, Rayquaza, Regice, Regidrago, Regieleki, Regigigas, Regirock, Registeel, Relicanth, Reshiram, Reuniclus, Rhydon, Rhyhorn, Rhyperior, Riolu, Roselia, Roserade, Rotom, Salamence, Sandile, Sceptile, Scizor, Scolipede, Scyther, Seadra, Sealeo, Seedot, Seismitoad, Sewaddle, Shaymin, Shedninja, Shelgon, Shieldon, Shiftry, Shinx, Shuppet, Skiploom, Slaking, Slakoth, Slowbro, Slowking, Slowpoke, Snorlax, Snorunt, Snover, Solosis, Spearow, Spheal, Spiritomb, Squirtle, Stakataka, Staraptor, Staravia, Starly, Steelix, Suicune, Swablu, Swadloon, Swampert, Swinub, Sylveon, TapuKoko, TapuLele, Tauros, Terrakion, Thundurus, Tirtouga, Togekiss, Togepi, Togetic, Torchic, Tornadus, Torterra, Totodile, Toucannon, Trapinch, Treecko, Trumbeak, Turtwig, Tympole, Typhlosion, Tyranitar, Tyrantrum, Tyrunt, Umbreon, Uxie, Vanillish, Vanillite, Vanilluxe, Vaporeon, Venipede, Venusaur, Vibrava, Victini, Victreebel, Vigoroth, Vileplume, Virizion, Volcarona, Walrein, Wartortle, Weedle, Weepinbell, Whirlipede, Whismur, Wigglytuff, Zapdos, Zekrom, Zubat, Zweilous } from './colyseus-models/pokemon'
