...
class Dialga extends Pokemon {
  constructor() {
    super(PKM.DIALGA, 'dialga',[TYPE.METAL, TYPE.DRAGON], RARITY.MYTHICAL, 'NEUTRAL', 483, '', 300, 30, 5, 5, 2, 'FIRE/range', ATTACK_TYPE.SPECIAL, 2, 150, SPECIAL_SKILL.ROAR_OF_TIME);
  }
}

class Palkia extends Pokemon {
  constructor() {
    super(PKM.PALKIA, 'palkia',[TYPE.DRAGON, TYPE.WATER], RARITY.MYTHICAL, 'NEUTRAL', 484, '', 300, 30, 5, 5, 1, 'DRAGON/melee', ATTACK_TYPE.PHYSICAL, 2, 150, SPECIAL_SKILL.ROAR_OF_TIME);
  }
}
...
class Oddish extends Pokemon {
  constructor() {
    super(PKM.ODDISH, 'mystherbe',[TYPE.POISON, TYPE.GRASS], RARITY.SUMMON, 'september', 43, PKM.GLOOM, 120, 9, 2, 2, 2, 'GRASS/range', ATTACK_TYPE.TRUE, 1, 100, SPECIAL_SKILL.STUN_SPORE);
  }
}

class Gloom extends Pokemon {
  constructor() {
    super(PKM.GLOOM, 'ortide',[TYPE.POISON, TYPE.GRASS], RARITY.SUMMON, 'september', 44, PKM.VILEPLUME, 230, 18, 3, 3, 2, 'GRASS/range', ATTACK_TYPE.TRUE, 2, 100, SPECIAL_SKILL.STUN_SPORE);
  }
}

class Vileplume extends Pokemon {
  constructor() {
    super(PKM.VILEPLUME, 'rafflesia',[TYPE.POISON, TYPE.GRASS], RARITY.SUMMON, 'september', 45, '', 360, 27, 4, 4, 2, 'GRASS/range', ATTACK_TYPE.TRUE, 3, 100, SPECIAL_SKILL.STUN_SPORE);
  }
}

class Bellossom extends Pokemon {
  constructor() {
    super(PKM.BELLOSSOM, 'joliflor',[TYPE.POISON, TYPE.GRASS], RARITY.SUMMON, 'september', 182, '', 360, 27, 8, 8, 2, 'GRASS/range', ATTACK_TYPE.TRUE, 3, 100, SPECIAL_SKILL.STUN_SPORE);
  }
}

class Amaura extends Pokemon {
  constructor() {
    super(PKM.AMAURA, 'amaura',[TYPE.FOSSIL, TYPE.ICE], RARITY.EPIC, 'fossil', 698, PKM.AURORUS, 150, 8, 4, 5, 1, 'ROCK/melee', ATTACK_TYPE.SPECIAL, 1, 100, SPECIAL_SKILL.ICICLE_CRASH);
  }
}

class Aurorus extends Pokemon {
  constructor() {
    super(PKM.AURORUS, 'aurorus',[TYPE.FOSSIL, TYPE.ICE], RARITY.EPIC, 'fossil', 699, '', 330, 14, 8, 10, 1, 'ROCK/melee', ATTACK_TYPE.SPECIAL, 2, 100, SPECIAL_SKILL.ICICLE_CRASH);
  }
}

class Anorith extends Pokemon {
  constructor() {
    super(PKM.ANORITH, 'anorith',[TYPE.FOSSIL, TYPE.BUG], RARITY.UNCOMMON, 'fossil', 347, PKM.ARMALDO, 70, 8, 3, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.ROCK_SMASH);
  }
}

class Armaldo extends Pokemon {
  constructor() {
    super(PKM.ARMALDO, 'armaldo',[TYPE.FOSSIL, TYPE.BUG], RARITY.UNCOMMON, 'fossil', 348, '', 160, 14, 4, 2, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.ROCK_SMASH);
  }
}

class Archen extends Pokemon {
  constructor() {
    super(PKM.ARCHEN, 'aéroptéri',[TYPE.FOSSIL, TYPE.FLYING], RARITY.RARE, 'fossil', 566, PKM.ARCHEOPS, 100, 10, 2, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.ROCK_SMASH);
  }
}

class Archeops extends Pokemon {
  constructor() {
    super(PKM.ARCHEOPS, 'aéroptéryx',[TYPE.FOSSIL, TYPE.FLYING], RARITY.RARE, 'fossil', 567, '', 180, 18, 3, 2, 2, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.ROCK_SMASH);
  }
}

class Shieldon extends Pokemon {
  constructor() {
    super(PKM.SHIELDON, 'dinoclier',[TYPE.FOSSIL, TYPE.METAL], RARITY.RARE, 'fossil', 410, PKM.BASTIODON, 120, 5, 3, 5, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.IRON_DEFENSE);
  }
}

class Bastiodon extends Pokemon {
  constructor() {
    super(PKM.BASTIODON, 'bastiodon',[TYPE.FOSSIL, TYPE.METAL], RARITY.RARE, 'fossil', 411, '', 240, 12, 7, 4, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.IRON_DEFENSE);
  }
}

class Tirtouga extends Pokemon {
  constructor() {
    super(PKM.TIRTOUGA, 'tirtouga',[TYPE.FOSSIL, TYPE.WATER], RARITY.RARE, 'fossil', 564, PKM.CARRACOSTA, 120, 5, 4, 2, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.ROCK_TOMB);
  }
}

class Carracosta extends Pokemon {
  constructor() {
    super(PKM.CARRACOSTA, 'carracosta',[TYPE.FOSSIL, TYPE.WATER], RARITY.RARE, 'fossil', 565, '', 240, 12, 7, 4, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.ROCK_TOMB);
  }
}

class Lileep extends Pokemon {
  constructor() {
    super(PKM.LILEEP, 'lilia',[TYPE.FOSSIL, TYPE.GRASS], RARITY.UNCOMMON, 'fossil', 345, PKM.CRADILY, 60, 6, 2, 2, 2, 'ROCK/melee', ATTACK_TYPE.SPECIAL, 1, 100, SPECIAL_SKILL.HEAL_BLOCK);
  }
}

class Cradily extends Pokemon {
  constructor() {
    super(PKM.CRADILY, 'vacylis',[TYPE.FOSSIL, TYPE.GRASS], RARITY.UNCOMMON, 'fossil', 346, '', 140, 12, 4, 4, 2, 'ROCK/melee', ATTACK_TYPE.SPECIAL, 2, 100, SPECIAL_SKILL.HEAL_BLOCK);
  }
}

class Cranidos extends Pokemon {
  constructor() {
    super(PKM.CRANIDOS, 'kranidos',[TYPE.FOSSIL, TYPE.MONSTER], RARITY.RARE, 'fossil', 408, PKM.RAMPARDOS, 100, 8, 4, 2, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.HEAD_SMASH);
  }
}

class Rampardos extends Pokemon {
  constructor() {
    super(PKM.RAMPARDOS, 'charkos',[TYPE.FOSSIL, TYPE.MONSTER], RARITY.RARE, 'fossil', 409, '', 200, 17, 6, 3, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.HEAD_SMASH);
  }
}

class Kabuto extends Pokemon {
  constructor() {
    super(PKM.KABUTO, 'kabuto',[TYPE.FOSSIL, TYPE.WATER], RARITY.UNCOMMON, 'fossil', 140, PKM.KABUTOPS, 70, 8, 3, 1, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.HEAL_BLOCK);
  }
}

class Kabutops extends Pokemon {
  constructor() {
    super(PKM.KABUTOPS, 'kabutops',[TYPE.FOSSIL, TYPE.WATER], RARITY.UNCOMMON, 'fossil', 141, '', 160, 14, 4, 2, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.HEAL_BLOCK);
  }
}

class Omanyte extends Pokemon {
  constructor() {
    super(PKM.OMANYTE, 'omanyte',[TYPE.FOSSIL, TYPE.WATER], RARITY.UNCOMMON, 'fossil', 138, PKM.OMASTAR, 60, 6, 1, 3, 2, 'ROCK/melee', ATTACK_TYPE.SPECIAL, 1, 100, SPECIAL_SKILL.ROCK_TOMB);
  }
}

class Omastar extends Pokemon {
  constructor() {
    super(PKM.OMASTAR, 'omastar',[TYPE.FOSSIL, TYPE.WATER], RARITY.UNCOMMON, 'fossil', 139, '', 140, 12, 2, 4, 2, 'ROCK/melee', ATTACK_TYPE.SPECIAL, 2, 100, SPECIAL_SKILL.ROCK_TOMB);
  }
}

class Tyrunt extends Pokemon {
  constructor() {
    super(PKM.TYRUNT, 'ptyranidur',[TYPE.FOSSIL, TYPE.DRAGON], RARITY.EPIC, 'fossil', 696, PKM.TYRANTRUM, 135, 10, 4, 2, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 1, 100, SPECIAL_SKILL.HEAD_SMASH);
  }
}

class Tyrantrum extends Pokemon {
  constructor() {
    super(PKM.TYRANTRUM, 'rexilius',[TYPE.FOSSIL, TYPE.DRAGON], RARITY.EPIC, 'fossil', 697, '', 290, 22, 7, 4, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.HEAD_SMASH);
  }
}

class Aerodactyl extends Pokemon {
  constructor() {
    super(PKM.AERODACTYL, 'ptéra',[TYPE.FOSSIL, TYPE.FLYING], RARITY.EPIC, 'february', 142, '', 300, 17, 6, 3, 1, 'ROCK/melee', ATTACK_TYPE.PHYSICAL, 2, 100, SPECIAL_SKILL.ROCK_SLIDE);
  }
}
