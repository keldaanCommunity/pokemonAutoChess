...
export default class Player extends Schema implements IPlayer{
  ...
  constructor(id: string, name: string, elo: number, avatar: string, isBot: boolean, rank: number, pokemonCollection: Map<string,IPokemonConfig>, title: Title | '', role: Role) {
    super()
    this.id = id
    this.name = name
    this.elo = elo
