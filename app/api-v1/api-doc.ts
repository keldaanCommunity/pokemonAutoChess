const apiDoc = {
  ...
  info: {
    ...
    description:
      "Pokemon Auto Chess API is free. Don't abuse it. Theres also rate limits that you can't exceed.",
    version: "0.1.0"
  },
  servers: [
    {
    ...
    schemas: {
      Pokemon: {
        ...
        properties: {
          ...
          avatar: {
            description:
              "the avatar of the pokemon (path including emotes/shiny user configuration)",
            type: "string"
          },
          inventory: {
      ...
      GameHistory: {
        ...
        properties: {
          ...
          name: {
            type: "string",
            description:
              "the game name (Name is specified by owner of preparation room)"
          },
          startTime: {
            type: "number",
