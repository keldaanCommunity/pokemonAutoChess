...
class Simulation extends Schema {
    ...
    constructor(blueTeam, redTeam) {
        ...
        for (let id in redTeam) {
            ...
            if(pokemon.positionY != 0){
                let pokemonEntity = new PokemonEntity(pokemon.index, pokemon.type, pokemon.positionX, 5 - (pokemon.positionY - 1), pokemon.hp, pokemon.atk, pokemon.range, 1, pokemon.attackSprite, pokemon.rarity);
