      ...
      .forEach((v) => {
        if (v) {
          ...
          if (
            ...
            if (egg) {
              const hatchEvolutionHandler = EvolutionManager.getHandler(egg.evolutionRule) as HatchEvolutionHandler
              egg.stacks = hatchEvolutionHandler.getHatchTime(egg, pokemon.player) - 1
            }
          }
