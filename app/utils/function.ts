...
export function debounce<T extends (...args: any) => any>(fn: T, delayInMs = 300): DebouncedFunction<T>{
...
export function throttle<T extends (...args: any) => any>(fn: T, delayInMs: number): ThrottledFunction<T> {
